...
namespace TaskNest.Frontend.Models
{
    public class HistoryInfo
    {
        ...
        [Range(typeof(decimal), "0", "79228162514264337593543950335", ErrorMessage = "Current amount must be at least 0.")]
        public decimal CurrentAmount { get; set; }

        [Required(ErrorMessage = "Adjusted amount is required.")]
        [Range(typeof(decimal), "0", "79228162514264337593543950335", ErrorMessage = "Adjusted amount must be at least 0.")]
        ...
        [RegularExpression("^[a-zA-Z0-9].*$", ErrorMessage = "Storekeeper name must be alphanumeric.")]
